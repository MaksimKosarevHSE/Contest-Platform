...
public class KafkaConfig {
    ...
    @Bean("solutionSubmittedKafkaListenerContainerFactory")
    public ConcurrentKafkaListenerContainerFactory<String, SolutionSubmittedEvent> solutionSubmittedKafkaListenerContainerFactory() {
